...
print("Array multidimensional", m)
...
#Prueba Bloque 0, columna 1
print('Prueba, b[0, ::2, -1] =', b[0, ::2, 1])
...
b.shape = (6,4)
print('Seis filas y cuatro columnas, b(6x4) =\n', b)
...
print('Dos filas con doce elementos(columnas), b =\n', b)